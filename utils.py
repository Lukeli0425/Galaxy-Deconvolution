...
def plot_loss(train_loss, val_loss, poisson, PnP, n_iters, n_epochs, survey, I):
    ...
    result_path = f'./saved_models/{"Poisson" if poisson else "Gaussian"}{"_PnP" if PnP else ""}_{n_iters}iters_{survey}{I}/'
