...
if __name__ == "__main__":
    ...
    test_psf_shear_err(methods=methods, shear_errs=shear_errs, model_files=model_files)
    test_psf_seeing_err(methods=methods, seeing_errs=seeing_errs, model_files=model_files)
