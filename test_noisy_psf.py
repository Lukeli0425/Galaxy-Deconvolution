...
def test_psf_seeing_err(n_iters, llh, PnP, n_epochs, survey, I, 
    ...
    for k, seeing_err in enumerate(seeing_errs):
        test_dataset = Galaxy_Dataset(train=False, survey=survey, I=I, psf_folder=f'psf_seeing_err{seeing_err}')
        ...
        results['rec_psnr'][str(seeing_err)] = rec_psnr
...
if __name__ == "__main__":
    ...
    test_psf_seeing_err(n_iters=opt.n_iters, llh=opt.llh, PnP=opt.PnP, n_epochs=opt.n_epochs, survey=opt.survey, I=opt.I)
